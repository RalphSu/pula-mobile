	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   @Override
	    public void onBackPressed() {
			...
			Intent intent = new Intent(RegistedUserBookingDialogActivity.this,CurriculumScheduleActivity.class);
	 ...
	 /**
		...
		private void showCustomMessage(String pTitle, final String pMsg) {
			final Dialog lDialog = new Dialog(RegistedUserBookingDialogActivity.this,
